...
sealed class NavScreens(var route: String, var icon: Int, var title: String) {
    ...
    object SkillBoard : NavScreens("SkillBoard", R.drawable.professionalimagethree, "Professional")
    object WhenJob : NavScreens("WhenJob", R.drawable.toilet, "WhenJob")
    object Books : NavScreens("books", R.drawable.ic_sea_icon, "Earnings")
    object Profile : NavScreens("Profile", R.drawable.profileimagetwo, "Profile")
    object WhenSkill: NavScreens("WhenSkill", R.drawable.ic_sea_icon, "WhenSkill")
    object PostTask: NavScreens("PostTask", R.drawable.taskimagethree, "Post Task")
    object Gig: NavScreens("Gig", R.drawable.gigimageone, "Gig")
